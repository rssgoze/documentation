...
2. 서버 내에서의 과도한 친목 행위를 금지합니다. 과도한 닉네임 및 실명 언급 역시 금지합니다.  
   사적인 대화는 스팀 채팅 또는 서버 공식 Discord를 이용해주세요.
3. 서버 내에서의 존댓말 사용을 권장합니다.
4. 서버 내에서 분쟁이 일어날 수 있는 주제는 피해 주세요.  
   이는 어그로를 끌 수 있는 모든 대화 주제를 포함합니다.
5. 타인을 비방하거나 공격적인 언행은 삼가 주세요.
6. 아래와 같은 내용의 언급 및 사용을 금지합니다.  
...
1. 스팸이나 도배 행위를 금지합니다.
2. 보이스 사용 시 한국어, 영어를 사용해주세요.
3. 변성기 이전 혹은 미성숙한 목소리로 보이스를 하는 행위를 금지합니다.
4. 히스 사용의 경우 다음과 같은 규정이 적용됩니다.  
    * 최대 길이 10초
    * 동일한 히스 반복 사용 금지
...
5. 맵 투표 및 관련 투표 시 보이스로 맵 관련 언급을 금지합니다.  
   이는 직접적, 간접적 언급을 모두 포함합니다.
6. 막장 보이스 및 과도한 잡담 보이스를 금지합니다.
7. 불쾌감을 줄 수 있는 보이스를 금지합니다.  
